...
protected static function booted()
{
    static::saved(function ($model) {
        ...
        if ($model->featured_image) {
            ...
            $source = storage_path('app/public/' . $model->featured_image);

            $destination = '/home/skezdyug/public_html/storage/' . $model->featured_image;
        ...
        if ($model->gallery && is_array($model->gallery)) {

            foreach ($model->gallery as $image) {

                $source = storage_path('app/public/' . $image);

                $destination = '/home/skezdyug/public_html/storage/' . $image;
